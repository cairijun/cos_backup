...
class TestArchive(unittest.TestCase):
    ...
    @classmethod
    def tmpfile(cls, *, content=b'', size=0):
        fd, path = tempfile.mkstemp(dir=cls._tmpdir)
